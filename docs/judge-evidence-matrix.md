...
| 0:12-0:28 | Message shortcut or `/signaldesk` in Slack sandbox. | Proves Slack is the product surface. |
...
- App Home onboarding, Demo guide modal, Proof checklist modal, `/signaldesk demo`, and no-input demo help are validated through unit and Block Kit checks.
